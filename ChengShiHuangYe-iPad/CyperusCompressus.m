...
@implementation CyperusCompressus
...
- (id)init
{
    ...
    {
        [self bubble];
        self.plant=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"cyperusCompressus"]];
        self.plant.alpha=0;
        ...
        self.bubble.frame=CGRectMake(plantWidth+10, plantHeight-bubbleHeight-bubbleHeight/2, bubbleWidth, bubbleHeight);
