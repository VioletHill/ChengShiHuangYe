...
@implementation DesmodiumCaudatum
...
- (id)init
{
    ...
    {
        [self bubble];
        self.plant=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"desmodiumCaudatum"]];
        self.plant.alpha=0;
        ...
        self.bubble.frame=CGRectMake(0, 0, bubbleWidth, bubbleHeight);
