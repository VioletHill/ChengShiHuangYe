...
@implementation Pachysandraterminalis
...
- (id)init
{
    ...
    {
        [self bubble];
        self.plant=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pachysandraterminalis"]];
        self.plant.alpha=0;
        ...
        self.bubble.frame=CGRectMake(0, plantHeight/2-bubbleHeight-bubbleHeight/2, bubbleWidth, bubbleHeight);
